<div id='zmWebToEntityForm' class="wsa-zoho-individual-webinar-register-form" style="width:100%;margin:auto;">
  ...
  <form action='https://webinar.zoho.com/meeting/WebForm' name=WebForm4248645000000367645 method='POST'
    ...
    <table border=0 cellspacing=0 cellpadding='6'
      style='background-color:#ffffff;background-color:white;color:black'>
        <td style='width: 100%; display: none;'>
          <select id='timezone' name='timezone' style='width: inherit;'>
            ...
            <option value='America/Sitka'>( GMT -09:00 ) Alaska Standard Time (America/Sitka)</option>
            ...
            <option value='America/Ojinaga'>( GMT -06:00 ) Central Standard Time (America/Ojinaga)</option>
            ...
            <option value='America/Anchorage'>( GMT -09:00 ) Alaska Standard Time (America/Anchorage)</option>
            ...
            <option value='CST6CDT'>( GMT -06:00 ) Central Standard Time (CST6CDT)</option>
            ...
            <option value='America/Menominee'>( GMT -06:00 ) Central Standard Time (America/Menominee)</option>
            ...
            <option value='America/Resolute'>( GMT -06:00 ) Central Standard Time (America/Resolute)</option>
            ...
            <option value='America/Glace_Bay'>( GMT -04:00 ) Atlantic Standard Time (America/Glace_Bay)</option>
            ...
            <option value='America/St_Johns'>( GMT -03:30 ) Newfoundland Standard Time (America/St_Johns)</option>
            ...
            <option value='America/Vancouver'>( GMT -08:00 ) Pacific Standard Time (America/Vancouver)</option>
            <option value='America/Rio_Branco'>( GMT -05:00 ) Acre Standard Time (America/Rio_Branco)</option>
            <option value='America/Detroit'>( GMT -05:00 ) Eastern Standard Time (America/Detroit)</option>
            ...
            <option value='America/Thule'>( GMT -04:00 ) Atlantic Standard Time (America/Thule)</option>
            ...
            <option value='America/Juneau'>( GMT -09:00 ) Alaska Standard Time (America/Juneau)</option>
            <option value='Europe/Astrakhan'>( GMT +04:00 ) Astrakhan Standard Time (Europe/Astrakhan)</option>
            <option value='America/Indiana/Vevay'>( GMT -05:00 ) Eastern Standard Time (America/Indiana/Vevay)</option>
            ...
            <option value='America/Goose_Bay'>( GMT -04:00 ) Atlantic Standard Time (America/Goose_Bay)</option>
            ...
            <option value='America/New_York'>( GMT -05:00 ) Eastern Standard Time (America/New_York)</option>
      ...
      <tr>
        <td style='width: 100%;'><input type='text' style='width: 100%;' maxlength='40' name='NAME' placeholder="First Name"></input></td>
      </tr>
      <tr>
        <td style='width: 100%;'><input type='text' style='width: 100%;' maxlength='100' name='REGISTRATIONCF1' placeholder="Last Name"></input>
        </td>
      </tr>
      <tr>

        <td style='width: 100%;'><input type='text' style='width: 100%;' maxlength='251' name='EMAIL' placeholder="Email *"></input></td>
      </tr>
      <tr>
        <td style='width: 100%;'><input type='text' style='width: 100%;' maxlength='100' name='REGISTRATIONCF7' placeholder="Phone *"></input>
        </td>
      </tr>
      ...
      <tr>
        <td colspan='2' align='center'> 
            ...
            <input type='reset' name='reset' style='font-size:12px;color:black; display: none;'
            value='Reset'></input>
      </tr>
    </table>
    <script>
...
.wsa-zoho-individual-webinar-register-form table,.wsa-zoho-individual-webinar-register-form  td,.wsa-zoho-individual-webinar-register-form  th {
    border: unset;
