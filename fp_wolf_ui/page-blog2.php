			...
			<article <?php post_class(); ?> data-animation="fadeInLeft">	
				...
				<div class="entry-wrap">	
					...
					<div class="excerpt-footer">
						...
						<div class="social">
							<span class="fb">
								<a href="http://facebook.com/share.php?u=<?php echo urlencode( get_the_permalink() ); ?>&amp;t=<?php echo urlencode( get_the_title() ); ?>" target="_blank"><i class="fa fa-facebook"></i></a>						
							</span>			
							
							<span class="twitter">
								<a href="http://twitter.com/home?status=<?php echo urlencode( get_the_title() ); ?>%20<?php echo urlencode( get_the_permalink() ); ?>" target="_blank"><i class="fa fa-twitter"></i></a>				
							</span>
						</div>
